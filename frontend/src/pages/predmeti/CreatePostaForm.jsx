...
const PredmetForm = () => {
    ...
    const handleDeleteExistingDok = (dok) => {
        setDokToDelete(dok);
    };
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                <Box sx={{p: 3}}>
                    ...
                    <Dialog
                        ...
                        fullWidth
                    >
                        <DialogTitle sx={{fontSize: '1rem', fontWeight: 700, color: T.accentDark}}>
                            Отстранување документ
                        </DialogTitle>
                        <DialogContent>
                            <Typography sx={{fontSize: '0.88rem', color: '#444'}}>
                                Дали сте сигурни дека сакате да го отстраните документот{' '}
                                „{dokToDelete?.imeFile}“?
                            </Typography>
                        </DialogContent>
                        <DialogActions sx={{px: 3, pb: 2}}>
                            <Button
                                onClick={() => setDokToDelete(null)}
                            ...
                            <Button
                                variant="contained"
                                disableElevation
                                onClick={confirmDeleteExistingDok}
                                sx={{
                                    textTransform: 'none', bgcolor: '#d32f2f',
