                        ...
                        {selected.map(id => {
                            ...
                            return (
                                <Chip key={id} label={item ? getLabel(item) : id}
                                      size="small" sx={{bgcolor: '#E8D8A0', fontSize: '0.75rem'}}/>
                            );
                        })}
                    </Box>
                )}
                ...
                <Box sx={{
                        ...
                        <Grid item xs={12} sm={6}>
                            <Box sx={{display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap'}}>
                                ...
                                <Box sx={{
                                    ...
                                    <Typography
                                        sx={{fontWeight: 'bold', color: '#333'}}>{today.year()} год.</Typography>
                                </Box>
                            </Box>
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <Box sx={{display: 'flex', alignItems: 'center', gap: 1}}>
                                ...
                                <DatePicker
                                    ...
                                    slotProps={{textField: {size: 'small', sx: {bgcolor: '#fff', width: 160}}}}
                                />
                            </Box>
                        </Grid>
                    </Grid>
                                    ...
                                    <RadioGroup value={form.tipPosta}
                                        ...
                                        {(tipPosta.length > 0 ? tipPosta : ['писмо', 'телеграма']).map(t => (
                                            <FormControlLabel key={t} value={t}
                                                              ...
                                                              label={<Typography
                                                                  sx={{fontSize: '0.85rem'}}>{t}</Typography>}
                                                              sx={{m: 0}}
                                            />
                                        ))}
                                    </RadioGroup>
                                    ...
                                    <RadioGroup value={form.prioritet}
                                        ...
                                        {(prioritet.length > 0 ? prioritet : ['Висок', 'Нормален']).map(p => (
                                            <FormControlLabel key={p} value={p}
                                                              control={<Radio size="small" sx={{py: 0.2}}/>}
                                                              label={<Typography
                                                                  sx={{fontSize: '0.85rem'}}>{p}</Typography>}
                                                              sx={{m: 0}}
                                            />
                                        ))}
                                    </RadioGroup>
                    ...
                    <Box sx={{mb: 2}}>
                        <Box sx={{display: 'flex', alignItems: 'center', gap: 1, mb: 1}}>
                            ...
                            {selectedIsprakjac && (
                                <Typography
                                    sx={{fontWeight: 'bold', color: '#333'}}>{selectedIsprakjac.naziv}</Typography>
                            )}
                        </Box>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={3}>
                            <ActionButton>Одговор{<br/>}испратена пошта</ActionButton>
                        </Grid>
                        <Grid item xs={12} sm={3}>
                            <ActionButton>СД одговор{<br/>}испратена пошта</ActionButton>
                        </Grid>
                        <Grid item xs={12} sm={3}>
                            <ActionButton>Одговор{<br/>}добиена пошта</ActionButton>
                        </Grid>
                    </Grid>
                </Box>
            </Container>
